...
public class Mmovie {
    ...
    public Mmovie(String name, Genre genre, double rating) {
        this.name = name;
        this.genre = genre;
        this.rating = rating;
    }
    ...
    private static final Mmovie[] movies = new Mmovie[] { 
            m("Green Mile", Genre.DRAMA, 8.5),
            ...
            m("Star Wars", Genre.ACTION, 8.7), 
            m("Thor", Genre.ACTION, 7) };
    
    private static Mmovie m(String name, Genre genre, double rating) {
        return new Mmovie(name, genre, rating);
    }
}
